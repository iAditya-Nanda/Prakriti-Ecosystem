...
export const SERVER_5000 = `${BASE_IP}:5000`; // Green Points Blockchain
export const SERVER_8000 = `${BASE_IP}:8000`; // AI Vision Server
export const SERVER_8001 = `${BASE_IP}:8001`; // AI Chat Server

// Core AI endpoints
export const CHAT_URL = `${SERVER_8001}/chat`;
export const CLEAR_URL = `${SERVER_8001}/clear_history`;
export const ANALYZE_URL = `${SERVER_8000}/analyze`;
